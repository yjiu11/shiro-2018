		      ...
		      <div class="modal-body" >
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-8">
						...
						<div id="allow_resource" style="height: 400px;overflow-y :scroll;"></div>
				    	<!-- <input type="text" class="form-control" id="update_locked" name="locked" placeholder="请选择..."> -->
				    </div>
				  </div>
				</form>
...
<script src="${APP_PATH }/static/js/role/list_tree.js"></script>
...
$(function() {
	...
	function getTree() {
		...
		return "{\"id\":0,\"type\":\"menu\",\"url\":\"/\",\"parentId\":-1,\"available\":1,\"children\":[{\"id\":1,\"type\":\"menu\",\"url\":\"\",\"parentId\":0,\"available\":1,\"children\":[{\"id\":2,\"type\":\"menu\",\"url\":\"/user/add*\",\"parentId\":1,\"available\":1,\"text\":\"用户添加\"},{\"id\":3,\"type\":\"menu\",\"url\":\"/user/update*\",\"parentId\":1,\"available\":1,\"text\":\"用户修改\"},{\"id\":4,\"type\":\"menu\",\"url\":\"/user/get*,/user/list*\",\"parentId\":1,\"available\":1,\"text\":\"用户查询\"},{\"id\":5,\"type\":\"menu\",\"url\":\"/user/delete*\",\"parentId\":1,\"available\":1,\"text\":\"用户删除\"},{\"id\":19,\"type\":\"menu\",\"url\":\"/user/allow_role\",\"parentId\":1,\"available\":1,\"text\":\"分配角色\"}],\"text\":\"用户权限\"},{\"id\":6,\"type\":\"menu\",\"url\":\"/page/top\",\"parentId\":0,\"available\":1,\"text\":\"导航\"},{\"id\":7,\"type\":\"menu\",\"url\":\"\",\"parentId\":0,\"available\":1,\"children\":[{\"id\":8,\"type\":\"menu\",\"url\":\"/role/add*\",\"parentId\":7,\"available\":1,\"text\":\"角色添加\"},{\"id\":9,\"type\":\"menu\",\"url\":\"/role/update*\",\"parentId\":7,\"available\":1,\"text\":\"角色修改\"},{\"id\":10,\"type\":\"menu\",\"url\":\"/role/get*,/role/list*\",\"parentId\":7,\"available\":1,\"text\":\"角色查询\"},{\"id\":11,\"type\":\"menu\",\"url\":\"/role/delete*\",\"parentId\":7,\"available\":1,\"text\":\"角色删除\"},{\"id\":17,\"type\":\"menu\",\"url\":\"\",\"parentId\":7,\"available\":1,\"text\":\"角色查询\"},{\"id\":20,\"type\":\"menu\",\"url\":\"/role/allow_resource\",\"parentId\":7,\"available\":1,\"text\":\"分配资源\"}],\"text\":\"角色权限\"},{\"id\":12,\"type\":\"menu\",\"url\":\"\",\"parentId\":0,\"available\":1,\"children\":[{\"id\":13,\"type\":\"menu\",\"url\":\"/resource/add*\",\"parentId\":12,\"available\":1,\"text\":\"资源添加\"},{\"id\":14,\"type\":\"menu\",\"url\":\"/resource/update*\",\"parentId\":12,\"available\":1,\"text\":\"资源修改\"},{\"id\":15,\"type\":\"menu\",\"url\":\"/resource/list*,/resource/get*\",\"parentId\":12,\"available\":1,\"text\":\"资源查询\"},{\"id\":16,\"type\":\"menu\",\"url\":\"/resource/delete*\",\"parentId\":12,\"available\":1,\"text\":\"资源删除\"}],\"text\":\"资源权限\"},{\"id\":18,\"type\":\"menu\",\"url\":\"/page/*\",\"parentId\":0,\"available\":1,\"text\":\"页面显示\"},{\"id\":22,\"type\":\"menu\",\"url\":\"/resource/get*\",\"parentId\":0,\"available\":1,\"text\":\"权限列表\"},{\"id\":23,\"type\":\"menu\",\"url\":\"**/common/*,/\",\"parentId\":0,\"available\":1,\"text\":\"通用资源\"}],\"text\":\"root\"}";
	}
</script>
